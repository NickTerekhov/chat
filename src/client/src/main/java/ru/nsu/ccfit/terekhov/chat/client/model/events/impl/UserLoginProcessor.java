...
public class UserLoginProcessor extends BaseEventProcessor<UserLoginEvent> {

    private final EventReceiver eventReceiver;

    public UserLoginProcessor(EventReceiver eventReceiver) {
    ...
    protected void process(UserLoginEvent event) {
        ...
        eventReceiver.userLogin(event.getUserName());
    }
